...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await context.bot.send_photo(chat_id=update.effective_chat.id, photo="https://i.im.ge/2021/10/23/oaWjzm.jpg")
    # https://fj.189.cn/ic/RechargeReceive?outTradeNo=202302150809193504452
    # await context.bot.send_photo(chat_id=update.effective_chat.id, photo="https://fj.189.cn/ic/RechargeReceive?outTradeNo=202302150809193504452")
    # https://imgur.com/Pbtrt1V
    await context.bot.send_photo(chat_id=update.effective_chat.id, photo="https://imgur.com/Pbtrt1V")
    # https://www.google.com/
    # await context.bot.send_photo(chat_id=update.effective_chat.id, photo="https://www.google.com")
